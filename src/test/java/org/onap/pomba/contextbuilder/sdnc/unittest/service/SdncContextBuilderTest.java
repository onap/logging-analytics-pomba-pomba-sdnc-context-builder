...
public class SdncContextBuilderTest {
    ...
    public void testRestHeaders() throws Exception {
        ...
        final MultivaluedMap<String, String> multivaluedMapImpl = buildHeaders(null,
                                                                               "testRestHeaders",
                                                                               sdncCtxBuilderBasicAuthorization);
        ...
        final MultivaluedMap<String, String> multivaluedMapImpl1 = buildHeaders("test2",
                                                                               "testRestHeaders",
                                                                                null);
        ...
        final MultivaluedMap<String, String> multivaluedMapImpl2 = buildHeaders("test2",
                                                                               "testRestHeaders",
                                                                                "garbage");
    ...
    public void testRestParameterServiceInstanceId() throws Exception {
        HttpHeaders mockHttpHeaders = mock( HttpHeaders.class);
        final MultivaluedMap<String, String> multivaluedMapImpl = buildHeaders("testRestParameterServiceInstanceId",
                                                                               "test1",
                                                                               sdncCtxBuilderBasicAuthorization);
        when(mockHttpHeaders.getRequestHeaders()).thenReturn(multivaluedMapImpl);
    ...
    public void testVerifySdncContextBuilder() throws Exception {
        ...
        HttpHeaders mockHttpHeaders = mock( HttpHeaders.class);
        final MultivaluedMap<String, String> multivaluedMapImpl = buildHeaders("testVerifyServiceDecomposition",
                                                                               "test1",
                                                                               sdncCtxBuilderBasicAuthorization);
        when(mockHttpHeaders.getRequestHeaders()).thenReturn(multivaluedMapImpl);
        ...
        final MultivaluedMap<String, String> multivaluedMapImpl1 = buildHeaders("testVerifyServiceDecomposition",
                                                                                null,
                                                                                sdncCtxBuilderBasicAuthorization);
        when(mockHttpHeaders.getRequestHeaders()).thenReturn(multivaluedMapImpl1);
    ...
    private static MultivaluedMap<String, String> buildHeaders(String partnerName, String transactionId, String authorization) {
